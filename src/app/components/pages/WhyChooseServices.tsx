...
const testimonials = [
  {
    quote:
      "Idatum didn't just help us get SOC 2 certified — they built the muscle memory in our team to maintain it. That's the difference between a vendor and a partner.",
    name: "Chief Information Security Officer",
    org: "Series B SaaS Company",
  },
  {
    quote:
      "We had tried two other firms before Idatum. They were the first to actually listen to how our business works before recommending a path forward.",
    name: "VP of Compliance",
    org: "Regional Financial Institution",
  },
  {
    quote:
      "Our ISO 27001 audit was the smoothest we've ever run. The Idatum team prepared us for every question before it was asked.",
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 17, color: "#C5D8EE", lineHeight: 1.8 }}>
            Hundreds of organizations have trusted Idatum to navigate their most
            complex compliance challenges. Here is why they chose us — and why
            they stay.
          </p>
        </div>
      </section>
          ...
          {reasons.map((r, index) => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: "200px" }}>
                ...
                <p style={{ fontSize: 14, color: "#4A6080", lineHeight: 1.7 }}>
                  {r.desc}
                </p>
              </div>
            </motion.div>
            ...
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <div style={{ borderTop: "1px solid #D1DCE8", paddingTop: 16 }}>
                  <p
                    style={{ fontSize: 13, fontWeight: 700, color: "#0D2B5A" }}
                  >
                    {t.name}
                  </p>
      ...
      >
        ...
        >
          <div style={{ flex: 1, minWidth: "260px" }}>
            ...
            <p style={{ fontSize: 15, color: "#C5D8EE" }}>
              Schedule a consultation with our QA team — no obligation, no sales
              pressure.
            </p>
          </div>
          <button
