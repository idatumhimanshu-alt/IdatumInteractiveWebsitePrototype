...
export function WhyIdatum({ navigate }: Props) {
  ...
  // The two core pillars for our interactive sliding accordion
  const panels = [
    {
      id: "philosophy",
      badge: "OUR CORE PHILOSOPHY",
      title: "Beyond Certification. Built for Business Excellence.",
      description:
        "While many consultants focus solely on achieving certification, we focus on building resilient organizations. Our consulting enhances operational performance, information security, governance, and compliance, ensuring your business is not only audit-ready but also better equipped for sustainable growth.",
      bullets: [
        "Audit readiness as a natural outcome, not a forced drill",
        "Deep integration of compliance into daily workflows",
        "Risk reduction that unlocks scalable enterprise growth",
      ],
      icon: Target,
    ...
    {
      id: "partnership",
      badge: "LONG-TERM COMMITMENT",
      title: "Your Growth Partner, Not Just an External Vendor.",
      description:
      ...
      bullets: [
        ...
        "Customized frameworks tailored to your industry nuances",
        "Pan-India network of certified auditors & trainers",
      ],
      icon: TrendingUp,
              ...
              >
                ...
                <motion.h2
                  ...
                  style={{
                    ...
                    minWidth: 260, // Prevents text from squishing too much when shrunk
                  }}
                >
                  {panel.title}
                </motion.h2>
                ...
                <AnimatePresence mode="popLayout">
                  {isActive && (
                    <motion.div
                      ...
                      style={{ minWidth: 400 }} // Prevents text reflow wrapping during animation
                    >
                      <p
                        style={{
                          fontSize: 17,
        ...
        >
          {[
            ...
            },
            {
              ...
              proof:
                "Clients who pair QA + Academy training sustain certification 2× longer on average.",
            },
            {
              num: "04",
