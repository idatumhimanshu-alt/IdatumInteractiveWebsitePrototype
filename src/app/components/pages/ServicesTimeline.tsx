      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 17, color: "#C5D8EE", lineHeight: 1.8 }}>
            A structured, six-phase engagement that takes your organization from
            current state to certified — with full transparency at every step.
          </p>
        </div>
      </section>
