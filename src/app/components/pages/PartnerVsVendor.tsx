...
export function PartnerVsVendor({ navigate }: Props) {
  const comparisons = [
    ...
    },
    {
      ...
      vendor:
        "Time-and-materials or fixed-fee; hours billed regardless of result",
    },
    {
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 17, color: "#C5D8EE", lineHeight: 1.8 }}>
            The compliance industry is full of vendors. Idatum is something
            different — a genuine partner that embeds accountability into every
            engagement.
          </p>
        </div>
      </section>
      ...
      >
        <div
          style={{
            ...
            borderRadius: 12,
            overflowX: "auto", // 👈 Enables smooth horizontal swipe on mobile without breaking page layout
        ...
        >
          <div style={{ minWidth: "650px" }}>
            {" "}
            {/* 👈 Ensures table columns maintain readable width on small screens */}
            {/* Table header */}
            <div
              style={{
                display: "grid",
            ...
            {comparisons.map((row, i) => (
              <div
                ...
                style={{
                  ...
                  gridTemplateColumns: "1fr 1fr 1fr",
                  borderBottom:
                    i < comparisons.length - 1 ? "1px solid #D1DCE8" : "none",
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 14, color: "#4A6080" }}>
              Start with a consultation to see how the partnership model works
              in practice.
            </p>
          </div>
          <button
