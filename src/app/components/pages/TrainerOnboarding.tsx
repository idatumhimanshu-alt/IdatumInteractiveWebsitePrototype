...
const steps = [
  {
    ...
    details: [
      "Credentials & certification verification",
      "Subject-matter expertise assessment",
      "Sample content or delivery review",
    ],
  },
  {
    num: "02",
    ...
    details: [
      ...
      "Delivery standards & expectations",
      "LMS and tooling walkthrough",
    ],
  },
  {
    num: "03",
    ...
    details: [
      "Facilitator guide review",
      "Case study and scenario bank access",
      "Assessment instrument walkthrough",
    ],
  },
  {
    num: "04",
    ...
    details: [
      "Live delivery with curriculum observer",
      "Real-time notes and structured debrief",
      "Evaluation against Idatum rubric",
    ],
  },
  {
    num: "05",
    ...
    details: [
      "Idatum Certified Trainer credential",
      "Trainer portal access",
      "First assignment scheduling",
    ],
  },
];
...
const tracks = [
  {
    ...
    color: "#1A5EA8",
    bg: "#EEF4FF",
    req: "IC Member experience or legal background in employment law",
  },
  {
    label: "ISMS",
    color: "#0D6B4E",
    bg: "#ECFDF5",
    req: "ISO 27001 Lead Implementer or CISM certification",
  },
  {
    label: "SOC 2",
    color: "#6B3DAB",
    bg: "#F5F0FF",
    req: "Active SOC 2 audit or implementation experience",
  },
  {
    label: "ISO",
    color: "#8B4513",
    bg: "#FFF7ED",
    req: "ISO Lead Auditor certification in relevant standard",
  },
  {
    label: "ITGC",
    color: "#B8370A",
    bg: "#FFF1EE",
    req: "CISA or equivalent IT audit qualification",
  },
  {
    label: "Audit",
    color: "#2B6A7C",
    bg: "#EFF8FC",
    req: "IIA membership and minimum 5 years audit experience",
  },
];
    ...
    >
        ...
        >
          ...
          >
            <div style={{ boxSizing: "border-box", width: "100%" }}>
              ...
              >
                Idatum Academy delivers training through a network of
                domain-certified practitioners. If you hold active credentials
                in any of our six training tracks, we'd like to hear from you.
              </p>
            ...
            {[
              {
                ...
                desc: "You are currently working in the domain you train — not just teaching it. We don't engage career trainers without domain experience.",
              },
              {
                title: "Certified & Current",
                desc: "You hold a recognized certification in your domain and keep it current. Expired credentials are not accepted.",
              },
              {
                title: "Facilitation Skill",
                desc: "You can engage an adult professional audience — not just lecture. Case-based discussion and scenario facilitation are core to our delivery model.",
              },
              {
                title: "India-Context Awareness",
                desc: "You understand how compliance frameworks apply in the Indian regulatory environment and can speak to local nuance.",
              },
            ].map((c) => (
              <div
                key={c.title}
      ...
      >
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          >
            From application to your first delivery assignment in as little as
            two weeks.
          </p>
        </div>
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              >
                ...
                >
                  <h3
                    style={{ fontSize: 17, fontWeight: 700, color: "#0D2B5A" }}
                  >
                    {step.title}
                  </h3>
                  <span
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 14, color: "#4A6080", marginBottom: 32 }}>
            Minimum credential requirements vary by training track. All tracks
            require active practitioner status.
          </p>
            ...
            {tracks.map((t) => (
              ...
              >
                ...
                <div style={{ padding: "16px 20px" }}>
                  <p
                    style={{ fontSize: 13, color: "#4A6080", lineHeight: 1.6 }}
                  >
                    {t.req}
                  </p>
                </div>
      ...
      >
        ...
        >
          ...
          >
            Ready to Deliver for Idatum Academy?
          </h2>
          <p
            style={{
              fontSize: 15,
          ...
          >
            Send us your credentials and a brief note about your experience.
