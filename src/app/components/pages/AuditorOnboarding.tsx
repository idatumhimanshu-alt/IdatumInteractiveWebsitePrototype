...
const steps = [
  {
    ...
    details: [
      "CISA / CISSP / ISO LA credential verification",
      "Engagement history review",
      "Domain specialisation assessment",
    ],
  },
  {
    num: "02",
    ...
    details: [
      "Idatum audit methodology overview",
      "Working paper and evidence standards",
      "Client interaction protocols",
    ],
  },
  {
    num: "03",
    title: "Tool & Compliance Toolkit Familiarisation",
    duration: "1 day self-paced",
    desc: "Access to Idatum's full audit toolkit — control testing workbooks, evidence request templates, gap registers, and reporting frameworks. All structured for consistency across engagements.",
    details: [
      "Control testing workbooks",
      "Evidence request templates",
      "Gap register and reporting formats",
    ],
  },
  {
    num: "04",
  ...
  },
  {
    ...
    details: [
      "Idatum Auditor Panel credential",
      "Independent assignment access",
      "Partner fee structure activation",
    ],
  },
];
...
const specialisations = [
  {
    ...
    req: "ISO 27001 Lead Auditor + minimum 3 ISMS engagements",
    color: "#0D6B4E",
    bg: "#ECFDF5",
  },
  {
    label: "SOC 2",
    req: "AICPA SOC examination experience as auditor or readiness lead",
    color: "#6B3DAB",
    bg: "#F5F0FF",
  },
  {
    label: "ISO 9001 / 22301",
    req: "ISO Lead Auditor in relevant standard + active certification body affiliation",
    color: "#8B4513",
    bg: "#FFF7ED",
  },
  {
    label: "ITGC / SOX",
    req: "CISA or CIA + minimum 4 years ITGC or SOX testing experience",
    color: "#B8370A",
    bg: "#FFF1EE",
  },
  {
    label: "Internal Audit",
    req: "CIA designation + IIA membership + minimum 5 years IA experience",
    color: "#2B6A7C",
    bg: "#EFF8FC",
  },
  {
    label: "Information Security",
    req: "CISSP or CISM + hands-on security assessment experience",
    color: "#1A5EA8",
    bg: "#EEF4FF",
  },
  {
    label: "Aerospace, Drone & Defense Tech",
    req: "AS9100 Lead Auditor credential + drone and defense manufacturing compliance experience",
    color: "#4A5568",
    bg: "#EDF2F7",
  },
  {
    label: "Education & HR Standards",
    req: "Specialized auditing background in educational institutions (NAAC/NBA accreditation) & human resource compliance frameworks",
    color: "#D69E2E",
    bg: "#FEFCBF",
  },
  {
    label: "Healthcare & Medical Devices",
    req: "ISO 13485 / NABL / NABH familiarity + healthcare compliance auditing background",
    color: "#319795",
    bg: "#E6FFFA",
  },
];
      ...
      >
        ...
        >
          <div style={{ boxSizing: "border-box", width: "100%" }}>
            ...
            >
              We are deliberate about who joins our auditor panel. Every
              engagement carries the Idatum name, and our clients rely on
              consistency. That means our auditors don't just meet minimum
              qualification thresholds — they reflect how Idatum thinks about
              quality.
            </p>
            <p
              style={{
            ...
            >
              Our auditors are expected to communicate findings clearly to
              non-technical stakeholders, exercise independent judgment, and
              maintain absolute client confidentiality. Technical knowledge is
              necessary but not sufficient.
            </p>
            {[
              {
                title: "Integrity First",
                desc: "No conflicts of interest, no commercial pressure on findings. Our auditors call it as they see it.",
              },
              {
                title: "Communication Clarity",
                desc: "Audit findings must be written and presented in language that enables action — not just satisfies an evidence checklist.",
              },
              {
                title: "Methodology Adherence",
                desc: "Idatum has defined working paper and evidence standards. Panel auditors follow them consistently.",
              },
            ].map((item) => (
              <div
                key={item.title}
              ...
              >
                ...
                <div>
                  ...
                  <p
                    style={{ fontSize: 13, color: "#4A6080", lineHeight: 1.7 }}
                  >
                    {item.desc}
                  </p>
                </div>
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 14, color: "#4A6080", marginBottom: 32 }}>
            Minimum credential requirements for each audit specialisation on the
            ...
            {specialisations.map((s) => (
              ...
              >
                ...
                <div style={{ padding: "16px 20px" }}>
                  <p
                    style={{ fontSize: 12, color: "#4A6080", lineHeight: 1.65 }}
                  >
                    {s.req}
                  </p>
                </div>
